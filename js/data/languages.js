...
const languages = {
  en: {
    ...
    translations: {
      ...
      "checkout.card": "Card",
      "checkout.disclaimer": "This demo does not process real payments. Subtotal:",
      "checkout.cancel": "Cancel",
      "checkout.placeOrder": "Place Order",
      "checkout.nameExample": "e.g. Alex Doe",
      "checkout.emailExample": "you@example.com",
      "checkout.addressExample": "Street, City",
      "checkout.cardExample": "•••• •••• •••• ••••",
      ...
      "footer.rights": "All rights reserved. Made with ♥ — pure HTML/CSS/JS",
  ...
  ar: {
    ...
    translations: {
      ...
      "checkout.card": "البطاقة",
      "checkout.disclaimer": "هذا العرض التوضيحي لا يعالج المدفوعات الحقيقية. المجموع الفرعي:",
      "checkout.cancel": "إلغاء",
      "checkout.placeOrder": "تأكيد الطلب",
      "checkout.nameExample": "مثال: أحمد محمد",
      "checkout.emailExample": "you@example.com",
      "checkout.addressExample": "الشارع، المدينة",
      "checkout.cardExample": "•••• •••• •••• ••••",
      ...
      "footer.rights": "جميع الحقوق محفوظة. صُنع بـ ♥ — HTML/CSS/JS خالص",
  ...
  fr: {
    ...
    translations: {
      ...
      "checkout.card": "Carte",
      "checkout.disclaimer": "Cette démo ne traite pas de vrais paiements. Sous-total:",
      ...
      "checkout.addressExample": "Rue, Ville",
      "checkout.cardExample": "•••• •••• •••• ••••",
      ...
      "footer.rights": "Tous droits réservés. Fait avec ♥ — HTML/CSS/JS pur",
